...
<div
            ...
            <div class="absolute inset-0 flex items-center justify-center p-8 lg:p-12">
                ...
                <div class="text-center text-white space-y-6 max-w-lg">
                    ...
                    <div class="space-y-4">
                        ...
                        <p class="text-sm md:text-base leading-relaxed text-white/80 max-w-sm mx-auto">
                            Avoid long queues and save time. Schedule your visit to any SSS branch anytime,
                            anywhere — fast and hassle-free.
                        </p>
                    ...
                    <p class="flex items-center justify-center gap-2 text-xs text-white/50 pt-2">
    ...
    <div class="{{ $isAppointmentStep ? 'w-full h-full' : 'w-full row-span-5 bg-white p-6 overflow-y-auto' }}">
        ...
        {{-- LANDING --}}
        @if ($page === 'landing')
            @include('livewire.register.steps.auth-choice')
        ...
        @elseif ($page === 'login')
            @switch($step)
                @case(1)
                    @include('livewire.register.steps.login')
                @break
